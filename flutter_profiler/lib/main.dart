  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      Padding(
        ...
        child: Text(
          '@Vecta16    |     victoronuchukwu.com',
          style: TextStyle(
              color: Colors.black54, fontSize: 12.0, letterSpacing: 1.0),
        ),
      ),
      Padding(
        ...
        child: Text(
          ...
          style: TextStyle(fontSize: 13.0, letterSpacing: 1.0),
        ),
      ),
      Divider(),
      SizedBox(
